...
void Image1(HDC hdc, int x, int y, int size) {
...
void Image2(HDC hdc, int cx, int cy, int size) {
    ...
    HPEN hPen;
    hPen = CreatePen(PS_SOLID, 3, RGB(230, 123, 45));
...
void Image3(HDC hdc, int cx, int cy, int size) {
    ...
    HPEN hPen;
    hPen = CreatePen(PS_SOLID, 4, RGB(12, 34, 12));
    SelectObject(hdc, hPen);
...
void Image4(HDC hdc, int cx, int cy, int size) {
    ...
    HPEN hPen;
    hPen = CreatePen(PS_SOLID, 1, RGB(45, 124, 7));
    SelectObject(hdc, hPen);
...
void RecursiveImage2_2(HDC hdc, int cx, int cy, int size) {
    Image2(hdc, cx, cy - size, size);
    if (size < 20) {
        return;
    }
    RecursiveImage2_2(hdc, cx - size, cy - 0.5 * size, size / 2);
    ...
    case WM_PAINT:
        {
            ...
            RecursiveImage2_2(hdc, 200, 500, 80);
            RecursiveImage1_1(hdc, 200, 160, 80);
            RecursiveImage3_3(hdc, 600, 160, 80);
            RecursiveImage4_4(hdc, 600, 500, 80);
